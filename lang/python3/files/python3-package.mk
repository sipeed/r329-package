...
HOST_PYTHON3_LIB_DIR:=$(OUT_DIR)/host/lib/python$(PYTHON3_VERSION)
HOST_PYTHON3_BIN:=$(OUT_DIR)/host/bin/python3

PYTHON3PATH:=$(PYTHON3_LIB_DIR):$(OUT_DIR)/$(PYTHON3_PKG_DIR):$(PKG_INSTALL_DIR)/$(PYTHON3_PKG_DIR)
define HostPython3
